...
def animate1(i):
    pullData = open("twitter_output_trump.txt","r").read()
    ...
    ax1.set_title('Tracking TrumpCare', size=20)
    ax1.plot(xar,yar)
...
##ani1.save('trump_animation.html')
#ßmpld3.save_html(ani1, 'trump_chart.html')
mpld3.show()
